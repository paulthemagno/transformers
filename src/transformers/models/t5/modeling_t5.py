...
@add_start_docstrings(
    """
    T5 Model transformer with a sequence classification/regression head on top (a linear layer on top of the pooled
...
class T5ForSequenceClassification(T5PreTrainedModel):
    def __init__(self, config):
        ...
        # this should be in T5Model, as it is in BertModel, but I inserted here not return different output in T5Model
        # T5Pooler is a copy of BertPooler
        # I commented 'if add_pooling_layer else None' not to add additional parameters, but there is a 'add_pooling_layer' param in BertModel
    ...
    def forward(
        ...
        # added from BertModel (but I wanted to use here not to break T5Model output)
